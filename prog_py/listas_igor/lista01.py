...
d) Cada variável utilizada pode ser acessada em qualquer parte do programa. FALSO

e) Não é permitido utilizar duas variáveis com o mesmo nome. FALSO
...
h) Os comentários permitem que o texto após o caractere "#" seja impresso na tela. FALSO

i) Duas variáveis definidas como “teste” e “Teste” são consideradas como idênticas. FALSO

j) Os operadores ( * + - / ) tem todos a mesma precedência. FALSO
'''
